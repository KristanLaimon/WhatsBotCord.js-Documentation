...
export default defineConfig({
  vite: {
    build: {
      // Inline styles into the HTML if they are smaller than 10kb (value in bytes)
  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        {
          label: "Release Notes",
          items: [{ label: "v2.0.0", slug: "release-notes" }],
        },
        {
        ...
        },
        {
          ...
          items: [{ label: "How would my index.ts look?", slug: "intermediate_advanced_concepts/main-setup" }],
        },
        {
          label: "Reference",
