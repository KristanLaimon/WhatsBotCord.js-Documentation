...
Commands can be invoked as **Tags** instead of normal prefixes. By default, tags are triggered via `@`. You can change this behavior setting the `tagCharPrefix` option when creating your Bot.
