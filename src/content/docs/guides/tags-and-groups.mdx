...
<Tabs>
  ...
  <TabItem label="TypeScript" icon="seti:typescript">
    ...
    import Whatsbotcord, { BaileysAdapter, CommandType, SenderType } from "whatsbotcord";

    class EveryoneTag implements ICommand {
      name: string = "everyone";
      aliases: string[] = ["e"];

      async run(ctx: IChatContext, _api: AdditionalAPI, args: CommandArgs): Promise<void> {
