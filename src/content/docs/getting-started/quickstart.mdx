...
export const botCode = `import Whatsbotcord, { type AdditionalAPI, type CommandArgs, type IChatContext, type ICommand } from "whatsbotcord";
...
2. **Add the bot code**
   ...
   **Interactive Playground**  
   Try it yourself! Toggle the widget in the header to see the chat interface.
   <CodeWidgetWrapper client:only="svelte" initialCode={botCode} />
