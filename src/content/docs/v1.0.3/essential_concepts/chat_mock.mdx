...
description: Execute and validate your commands in a locally simulated WhatsApp
  environment without requiring QR scans or active sockets.
slug: v1.0.3/essential_concepts/chat_mock
---
...
* **`args`**: Simulates text appended to the command trigger (e.g., `["@user", "value"]`). This maps directly to the [`CommandArgs`](/v1.0.3/essential_concepts/command_args) payload.
