          ...
          <div class="tab-icon">
            {#if tab.name.endsWith(".ts")}
              <svg viewBox="0 0 100 100" width="14" height="14">
                ...
                <text x="50" y="70" font-family="system-ui, sans-serif" font-weight="900" font-size="52" fill="#ffffff" text-anchor="middle">TS</text>
              </svg>
            {:else if tab.name.endsWith(".js")}
              <svg viewBox="0 0 100 100" width="14" height="14">
                <rect width="100" height="100" fill="#f7df1e" rx="15"/>
                <text x="50" y="70" font-family="system-ui, sans-serif" font-weight="900" font-size="52" fill="#000000" text-anchor="middle">JS</text>
              </svg>
            {:else}
